...
export const Careers = () => {
  return (
    <div className="flex flex-col w-full">
      ...
      >
        <form className="flex flex-col gap-3 flex-5 bg-background p-8 rounded-sm max-md:px-4">
          <div className="flex flex-col gap-1 mb-10 ml-2">
            <SpanL className="text-3xl text-primary-variant font-medium">
              Careers.formTitle
            </SpanL>
            <SpanL className="text-sm opacity-70">
              Careers.formDescription
            </SpanL>
          </div>
          <div className="flex gap-3 max-md:flex-col">
            <InputL
              ...
              required
              name="nameSurname"
              placeholder="Careers.Form.nameSurname"
            />
            <ComboBoxL
              variants={blockVariants}
          ...
          <div className="flex gap-3 max-md:flex-col">
            <InputL
              ...
              required
              name="email"
              placeholder="Careers.Form.email"
            />
            <InputL
              variants={blockVariants}
              transition={{ delay: 0.6, duration: 0.3 }}
              name="phone"
              placeholder="Careers.Form.phone"
            />
          </div>
          <InputL
            variants={blockVariants}
          ...
          />
          <CheckboxL label="Careers.Form.workedHere" className="my-2" />
          <ButtonL
            upperCase
            type="submit"
            className="bg-primary-variant text-on-primary text-sm font-medium px-6 py-3 h-max min-w-max mr-auto mt-5"
          >
            Careers.Form.submit
          </ButtonL>
        </form>
        <div className="flex flex-3 flex-col gap-12 sticky top-1/4 h-max mt-2 max-2xl:gap-8 max-2xl:top-1/5 max-md:static max-md:px-[5%]">
          ...
          <div className="flex flex-col gap-8 text-xl max-2xl:gap-4 max-2xl:-ml-10">
            <motion.div
              variants={blockVariants}
              transition={{ delay: 0.3, duration: 0.3 }}
              className="flex items-center gap-4 max-2xl:scale-80"
            >
              <FaMoneyBillTrendUp
                size={48}
                className="text-secondary bg-background p-2 rounded-sm"
              />
